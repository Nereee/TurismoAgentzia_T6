    ...
    <html lang="eu">
        ...
        <body>
            ...
            <main>
                    ...
                    <fieldset>
                        ...
                        <div class="blokea" id="hegaldiaBlokea" style="display: none;">        
                            ...
                            <div class="blokea" id="joanetorriBlokea" style="display: none;">
                                ...
                                <!-- Gordetzeko botoia -->
                                <input type="submit" id="hegaldiaGordeBuelta" name="hegaldiaGordeBuelta" value="Gorde Hegaldia (Joan/Etorri)">
                            </div>
                        </div>
                        ...
                        <div class="blokea" id="ostatuaBlokea" style="display: none;">
                            ...
                            <!-- Gordetzeko botoia -->
                            <input type="submit" id="ostatuaGorde" name="ostatuaGorde" value="Gorde Ostatua">
                        </div>
                ...
                <!-- Laburpen taula -->
                <div id="taula-container-hegaldia" style="display: none;">
                    <table id="laburpen-taula-hegaldia">
                        <thead>
                            <tr>
                                <th colspan="10 ">Hegaldiaren Laburpena</th>
                            </tr>
                            <tr>
                                <th>Bidaia Mota</th>
                                <th>Zerbitzua</th>
                ...
                <div id="taula-container-hegaldiaBuelta" style="display: none;">
                    <table id="laburpen-taula-hegaldiaBuelta">
                        <thead>
                            <tr>
                                <th colspan="15">Hegaldia (Joan/Etorria) Laburpena</th>
                            </tr>
                            <tr>
                                <th>Bidaia Mota</th>
                                <th>Zerbitzua</th>
                ...
                <div id="taula-container-ostatua" style="display: none;">
                    <table id="laburpen-taula-ostatua">
                        <thead>
                            <tr>
                                <th colspan="8">Ostatuaren Laburpena</th>
                            </tr>
                            <tr>
                                <th>Bidaia Mota</th>
                                <th>Zerbitzua</th>
                ...
                <div id="taula-container-bestebatzuk" style="display: none;">
                    <table id="laburpen-taula-bestebatzuk">
                        <thead>
                            <tr>
                                <th colspan="8">Zerbitzuen Laburpena</th>
                            </tr>
                            <tr>
                                <th>Bidaia Mota</th>
                                <th>Zerbitzua</th>
